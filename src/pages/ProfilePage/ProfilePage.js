...
import Telegram from "../../image/telegram-computer.png"
...
useEffect(()=> {
    ...
    useEffect(()=> {
        ...
        const newProject2 = {
            id: 2,
            title: 'Little Big Show',
            date_start: '01.02.2025',
            date_end: '02.02.2025',
            dateMain: '',
            tgURL_chat: '',
            status: '',
            specs: {date: '2025-04-22T10:00' },
            smeta: '',
            finalSmeta: '',
            statusMoney: 2,
            stavka: '18000',
        ...
        const newProject3 = {
            ...
            tgURL_chat: '',
            status: '',
            specs: {date: '2025-04-20T12:00', spec: 'Звукорежессер', vid: 'Монтаж',  },
            smeta: '',
            finalSmeta: '',
            statusMoney: 4,
            stavka: '10000',
        ...
        <div className="App" style={{overflowX: 'hidden'}}>
            ...
            <div className="container">
                ...
                <div style={{display: 'flex', marginTop: '15px', justifyContent: 'space-between'}}>
                    ...
                    <div style={{position: 'relative', width: '100%', display: 'flex', flexDirection: 'column', flex: '0 0 56%'}}>
                        ...
                        <article className='block-dohod' onClick={clickDohod} style={{display: showDohod || showKompet ? 'none' : 'block'}}> 
                            ...
                            <p className='summa-dohod'>{isLoadingSum ? <Loader2 /> : (user?.id.toString() === '1408579113' ? '128 650' : (isNaN(summa) ? "0" : parseInt(summa).toLocaleString())) +".00"}</p>
                        </article>
                    </div> 
                </div>
                ...
                <article className='block-dohod-open' onClick={clickDohod} style={{display: showDohod ? 'block' : 'none'}}>
                    ...
                    <p className='summa-dohod2'>{isLoadingSum ? <Loader2 /> : (user?.id.toString() === '1408579113' ? '128 650' : (isNaN(summa) ? "0" : parseInt(summa).toLocaleString())) + ".00"}</p>
                </article>
            ...
            <div className='footer-block' style={{display: showFooter ? 'block' : 'none'}}>
                ...
                <div className='footer-icons2'> 
                    ...
                    {/* openInNewTab('https://t.me/uley_team')  */}
